  ...
  getAllUsernames()
    .then((userArray) => {
      ...
      allMessagesArray.forEach((message) => {
        ...
        string += `<div class="panel panel-primary" id="messages-panel">`;
        string += `<h4 id="WhoSaidIt" class="nameOfUser" data-nameOfUser="${sender}">${sender}</h4>`;
        string += `<div>`;
        string += `<input type="text" id="changeMessageTextField" class="hide form-control" placeholder="" value="${message.message}">`;
        string += `<p id="userMessage" class="theMessage" data-theMessage="${message.message}">${message.message}</p>`;
        ...
        string += `<button id="saveEdit" type="button" class="hide btn btn-default btn-xs">`;
        ...
        string += `</button>`;
        string += `<button id="deleteButt" type="button" class="btn btn-default btn-xs">`;
